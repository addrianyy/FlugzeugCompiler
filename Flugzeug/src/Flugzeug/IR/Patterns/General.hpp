...
template <typename Class> class ValueBindingPattern {
  Class** bind_value;
...
template <bool Unsigned> class ConstantBindingPattern {
public:
...
template <typename TValue> class ExactValuePattern {
...
template <typename TValue> class ExactValueRefPattern {
...
template <bool Unsigned> class ExactConstantPattern {
public:
  using Type = std::conditional_t<Unsigned, uint64_t, int64_t>;
...
template <typename Pattern> class TypeCheckingPattern {
  Type* type;
  Pattern sub_pattern;
...
template <typename T> auto value(T*& v) { return detail::ValueBindingPattern<T>(&v); }
template <typename T> auto value(const T*& v) { return detail::ValueBindingPattern<const T>(&v); }

inline auto constant() { return detail::ValueBindingPattern<const Constant>(nullptr); }
inline auto constant(Constant*& v) { return detail::ValueBindingPattern<Constant>(&v); }
inline auto constant(const Constant*& v) { return detail::ValueBindingPattern<const Constant>(&v); }

inline auto undef() { return detail::ValueBindingPattern<const Undef>(nullptr); }
inline auto undef(Undef*& v) { return detail::ValueBindingPattern<Undef>(&v); }
inline auto undef(const Undef*& v) { return detail::ValueBindingPattern<const Undef>(&v); }

inline auto block() { return detail::ValueBindingPattern<const Block>(nullptr); }
inline auto block(Block*& v) { return detail::ValueBindingPattern<Block>(&v); }
inline auto block(const Block*& v) { return detail::ValueBindingPattern<const Block>(&v); }

inline auto function() { return detail::ValueBindingPattern<const Function>(nullptr); }
inline auto function(Function*& v) { return detail::ValueBindingPattern<Function>(&v); }
inline auto function(const Function*& v) { return detail::ValueBindingPattern<const Function>(&v); }
...
template <typename T> auto exact(const T* value) { return detail::ExactValuePattern<T>(value); }
template <typename T> auto exact_ref(T*& value) { return detail::ExactValueRefPattern<T>(value); }
template <typename T> auto exact_ref(const T*& value) {
  return detail::ExactValueRefPattern<const T>(value);
}

inline auto exact_u(uint64_t value) { return detail::ExactConstantPattern<true>(value); }
inline auto exact_i(int64_t value) { return detail::ExactConstantPattern<false>(value); }

inline auto zero() { return detail::ExactConstantPattern<true>(0); }
inline auto one() { return detail::ExactConstantPattern<true>(1); }
inline auto negative_one() { return detail::ExactConstantPattern<false>(-1); }
